...
<div id="middle">
    ...
    <table id="UserList" border="1" cellspacing="0" style="border-collapse:collapse; border-width:thin; border-style:solid; margin-top:10px;">
        <tr>
            ...
            <td width="100" height="35" align="center" valign="middle" bgcolor="#DDD">快递员身份申请状态</td>
            <td width="200" align="center" valign="middle" bgcolor="#DDD">操作</td>
        </tr>
        <%
            UserDao userDaoImpl=new UserDao();
            List<User> list=userDaoImpl.selectKUser();
            for(User user:list)
            {%>
        <tr>
            ...
            <td width="100" height="40" align="center" valign="middle"><%=user.iskCheck()%></td>
...
<div id="dialogProve" title="是否确认通过?" style="display:none">
    <form action="${pageContext.request.contextPath}/user?method=proveUser_k" method="post" style="text-align:center">
...
<div id="dialogCancel" title="是否确认拒绝?" style="display:none">
    <form action="${pageContext.request.contextPath}/user?method=cancelUser_k" method="post" style="text-align:center">
