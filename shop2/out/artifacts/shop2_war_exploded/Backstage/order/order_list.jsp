...
<%@ page import="com.shop.dao.OrdersDao,com.shop.entity.Orders"%>
<%
...
<script>
    function searchOrder(){
	  ...
	  xmlhttp.open("GET","../ajax/searchOrders.jsp?key="+key,false);
	  xmlhttp.send();
	}
    ...
    $(function() {
    	$("#dialogDelete").dialog({
    	 ...
    	 $(document).on('click', '.btn-delete', function () {
 		    ...
 		    xmlhttp.open("GET","../ajax/deleteOrder.jsp?key="+key,false);
 		  	xmlhttp.send();  
...
<body>
 <div id="top">
    ...
    <div id="middle">
     ...
     <table id="OrderList" border="1" cellspacing="0" style="border-collapse:collapse; border-width:thin; border-style:solid; margin-top:10px;">
         <tr>
  		 ...
  		 <%
            ...
            List<Orders> list=orderDaoImpl.selectAllOrders();
            for(Orders order:list)
         {%>
         <tr>
           <td width="150" height="40" align="center" valign="middle"><%=order.getoID()%></td>
           <td width="150" height="40" align="center" valign="middle"><%=order.getgID()%></td>
           <td width="100" height="40" align="center" valign="middle"><%=order.getoNum()%></td>
           <td width="100" height="40" align="center" valign="middle"><%=order.getoPrice()%>
           <td width="200" height="40" align="center" valign="middle"><%=order.getoState()%></td>
           <td width="200" height="40" align="center" valign="middle"><%=order.getoTip()%></td>
           <td width="150" height="40" align="center" valign="middle"><%=order.getoTime()%></td>
           <td width="100" height="40" align="center" valign="middle"><%=order.getUserID()%></td>
           <td width="100" height="40" align="center" valign="middle"><%=order.getUserAddress()%></td>
	...
	<div id="dialogDelete" title="是否确认删除?" style="display:none">
		<form action="${pageContext.request.contextPath}/orders?method=delOrders_admin" method="post" style="text-align:center">
